...
/**
 * file should be index.php
 *
 * This file handles secure mail transport using the Mailgunner
...
try {
	...
	$mailgun->messages()->sendMime($mailgunDomain, $MAIL_RECIPIENTS, $swiftMessage->toString(), []);
	...
	echo "<div class=\"alert alert-danger\" role=\"alert\"> Unable to send email: " . $exception->getMessage() . " " . $exception->getFile() . "</div>";
}